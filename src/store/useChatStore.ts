...
import { validateMessage, validateEmail } from "../utils/validation";
...
export const useChatStore = create<ChatStore>((set, get) => ({
    ...
    // Subscribe to Users (Real-time) - DEPRECATED: Use subscribeToContacts instead
    subscribeToUsers: (): (() => void) | null => {
        const authUser = useAuthStore.getState().authUser;
    ...
    startUsersListener: () => {
        ...
        // Use subscribeToContacts instead of subscribeToUsers
